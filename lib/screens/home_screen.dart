...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final highlightCardBg = isDark ? const Color(0xFF1E293B) : const Color(0xFFE0F2FE);
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Today's Screen Time",
                          style: TextStyle(fontSize: 13, color: primaryTextColor, fontWeight: FontWeight.bold),
                        ),
                        const SizedBox(height: 4),
                        Text(
                          '1h 42m',
                          style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: bodyTextColor),
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              'from yesterday',
                              style: TextStyle(fontSize: 11, color: challengeTextCol, fontWeight: FontWeight.bold),
                            ),
                          ],
                        ),
                      ],
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '7',
                              style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold, color: bodyTextColor),
                            ),
                            const SizedBox(width: 4),
                            Text(
                              'Days',
                              style: TextStyle(fontSize: 18, color: bodyTextColor, fontWeight: FontWeight.bold),
                            ),
                          ],
                        ),
                        const SizedBox(height: 6),
                        Text(
                          ...
                          style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: challengeTextCol),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(
                          ...
                          height: 40,
                          fit: BoxFit.contain,
                          errorBuilder: (context, error, stackTrace) => Icon(Icons.android, size: 36, color: primaryTextColor),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.sports_esports_outlined, size: 16, color: challengeTextCol),
                                  const SizedBox(width: 4),
                                  Text(
                                    "Today's Challenge",
                                    style: TextStyle(fontWeight: FontWeight.bold, color: challengeTextCol, fontSize: 13),
                                  ),
                                ],
                              ),
                              const SizedBox(height: 8),
                              ...
                              SizedBox(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(fontSize: 10, color: challengeTextCol, height: 1.3),
                                ),
                              ),
                              const Spacer(),
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: isDark ? const Color(0xFF9FA8DA) : const Color(0xFF204A94),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.lightbulb_outline, size: 16, color: challengeTextCol),
                                  const SizedBox(width: 4),
                                  Text(
                                    "Daily Insight",
                                    style: TextStyle(fontWeight: FontWeight.bold, color: challengeTextCol, fontSize: 13),
